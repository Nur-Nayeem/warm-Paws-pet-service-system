...
const ServiceCard = ({ service }) => {
  ...
  return (
    <div className="flex flex-col gap-5 rounded-2xl bg-base-200 shadow-lg hover:shadow-2xl overflow-hidden transition-all hover:-translate-y-0.5 duration-300 h-full">
